package com.Maksim1803.andrfindmusicapp.viewmodel

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.Maksim1803.andrfindmusicapp.data.local.TrackEntity
import com.Maksim1803.andrfindmusicapp.data.model.Track
import com.Maksim1803.andrfindmusicapp.data.remote.RetrofitClient
...
class HomeViewModel @Inject constructor(
    ...
    private val trackDao: com.Maksim1803.andrfindmusicapp.data.local.TrackDao
) : ViewModel() {
    ...
    private fun fetchTracksByTag(tag: String) {
        viewModelScope.launch {
            ...
            try {
                ...
                _networkError.value = com.Maksim1803.andrfindmusicapp.R.string.error_slow_connection
            } catch (e: Exception) {
                _networkError.value = com.Maksim1803.andrfindmusicapp.R.string.error_no_internet
            } finally {
